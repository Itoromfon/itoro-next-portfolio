...
export const navData = [
    ...
    // {
    //     name: 'Resume',
    //     path: 'https://drive.google.com/file/d/1UYy7WIn2rCM7wF7YjOcuwciJdzC9josR/view?usp=sharing6uy7',
    //     icon: <HiEnvelope />,
    // },
];
    ...
    return ( 
        ...
        z-50 top-0 w-full xl:w-16 xl:max-w-md xl:h-screen">
            ...
            <div className="flex w-full xl:flex-col 
                items-center justify-between xl:justify-center 
                gap-y-10 px-4 md:px-40 xl:px-0 h-[80px] 
                bg-red-200/10 xl:h-max py-8 
                backdrop-blur-sm text-2xl md:text-3xl xl:text-xl
                xl:rounded-full
            ">
